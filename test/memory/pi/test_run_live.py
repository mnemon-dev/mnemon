...
"""
    ...
    def test_real_sdk_failure_cleans_scope_and_never_produces_a_score(self):
        ...
        self.assertIn('per bash tool call', bash['description'])
        self.assertIn('Multiple separate tool calls are allowed', bash['description'])
        ...
        self.assertIn('per bash tool call', system)
        self.assertIn('Multiple separate tool calls are allowed', system)
